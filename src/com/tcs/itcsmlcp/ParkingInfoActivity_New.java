...
//	 TextView cars,slots_cars,bikes,slots_bikes;
	...
	/*	 // Make us non-modal, so that others can receive touch events.
		...
		btnRefresh.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				new LongOperation_bookslot(serverURL_bookslot,ParkingInfoActivity_New.this).execute("");
			}
		});
...
//					e.printStackTrace();
	    	  progress=ProgressDialog.show(ParkingInfoActivity_New.this, "", "");
...
//	          	uiUpdate.setText( Content );
	           ...
	           /****************** Start Parse Response JSON Data *************/
	             ...
	             String slot_result="";int slot_no_cars=0,car_no=0;//,slot_no_bikes=0,bike_no=0;
...
//	                        emp_shift = jsonChildNode.optString("emp_shift").toString();
	                        ...
	                        slot_no_cars = jsonChildNode.optInt("tot_slots_car");
//	                        slot_no_bikes = jsonChildNode.optInt("tot_slots_bike");
	                        car_no = jsonChildNode.optInt("tot_cars");
...
//	                        values1[3] = String.valueOf(slot_no_bikes-bike_no);
	                	   ...
	                	   ParkingInfoColorArrayAdapter adapter = new ParkingInfoColorArrayAdapter(ParkingInfoActivity_New.this, values,values1,images);
...
//									"Sorry for inconvience! PARKING FULL", false);
		                   Toast.makeText(ParkingInfoActivity_New.this, "Error in fetching parking info! ", Toast.LENGTH_LONG).show();
